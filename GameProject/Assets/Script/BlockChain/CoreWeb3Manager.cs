...
public class CoreWeb3Manager : MonoBehaviour
{
    ...
    // address of contract
    public const string contract = "0x4BE1D71702b45B14297f41B23c747fC717617ea2";
    public const string contractToken = "0xDF813373a6a483e3Cd968f32Fa19dcbe8953B415"; // catalyst
  
    //const string network = "testnet";
    const string chainId = "5001";
    static string networkRPC= "https://rpc.testnet.mantle.xyz";
